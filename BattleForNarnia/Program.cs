...
namespace BattleForNarnia
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("I understand this is your first time on the Battlefield?");

            string response = Console.ReadLine();

                if (response == "yes")
                {
                    Console.WriteLine("Not to worry! Let's get you fitted with Armour and a Blade!");
                }
                else if (response == "no")
                {
            ...
            response = Console.ReadLine();
                ...
                Console.WriteLine("Reepicheep: Now that your fitted, lets get you a blade!");
                Console.WriteLine("This is is Rabidash, finest Bladesmith in all the land!");
                Console.WriteLine("Rabidash: Hello there!");
